...
redacted OS is intended for educational, experimental, and personal use. While reasonable care is taken during development, the project may contain bugs, incomplete features, or design changes at any time. Users are responsible for backing up their data and understanding the actions they perform while installing or using the system.
Any similarities in name, appearance, or functionality to other operating systems or projects are coincidental unless explicitly stated. redacted OS does not claim ownership over the word “Arch,” “Linux,” or any related trademarks.
By using redacted OS, you acknowledge and accept these terms.
Optional shorter disclaimer (for Twitter / README footer)
redacted OS is an independent, Arch-based Linux project and is not affiliated with or endorsed by Arch Linux. Provided as-is, without warranty.
